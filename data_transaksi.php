            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="data_member.php">Data Member</a>
       ...
       <tbody>
        ...
        while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
          ...
          <tr>
            ...
            <td>
            <a href="ubah_proses.php?id_transaksi=<?=$data_transaksi['id_transaksi'] ?>" style="color: black">Proses</a> | 
            <a href="ubah_selesai.php?id_transaksi=<?=$data_transaksi['id_transaksi']?>" style="color: black">Selesai</a> | 
            <a href="ubah_diambil.php?id_transaksi=<?=$data_transaksi['id_transaksi']?>" style="color: black">Diambil</a>
            <style>
                a:link{
                    color: black;
